        ...
        <section className="public-section">
          <div className="section-head">
            <div>
              ...
              <p>جرّب لمحة قصيرة من طريقة التعلّم داخل المنصة، واكتشف كيف تتحول الفكرة إلى موقف تطبيقي واضح.</p>
            </div>
          </div>
          ...
          <div className="two-grid">
            ...
            <div className="sample-box sample-simulation">
              ...
              <ul className="sample-bullets">
                <li>موقف قصير يحاكي قرارًا مهنيًا واقعيًا.</li>
                <li>اختيارات تساعدك على اختبار طريقة تفكيرك.</li>
                <li>تغذية راجعة فورية توضّح منطق القرار الأنسب.</li>
              </ul>
